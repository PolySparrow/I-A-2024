...
br_random_objectives = {
	...
	// Create radio tower
	if (br_radio_tower_enabled) then {["Radio_Tower", "Radio Tower", 8, selectrandom (call radio_towers), "Destory & Kill", TRUE, "Radio Tower Destroyed!", _groupSpawn, TRUE, TRUE, "Border", "ELLIPSE", getMarkerPos "ZONE_RADIUS", TRUE, [], FALSE,1] execVM "core\server\zone_objective\fn_createObjective.sqf";};
